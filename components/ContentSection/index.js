...
// Remove imports for ReactMarkdown, remarkGfm, SyntaxHighlighter if they were here

const ContentSection = ({ content }) => { // 'content' PROPS holds PRE-COMPILED HTML
  return (
    // Apply Tailwind prose classes for styling the rendered HTML
    <article
      className="prose lg:prose-xl dark:prose-invert max-w-none mx-auto mt-8 mb-10 px-4"
...
ContentSection.propTypes = {
  content: PropTypes.string.isRequired, // Expecting an HTML string
};
