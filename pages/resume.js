...
// Data: Use the default import 'data' consistently
...
const Resume = () => {
  ...
  // ... (rest of the component is likely okay, but check if you used
  //      the destructured `name` or `resume` anywhere else and change
  //      them to `data.name` and `data.resume` respectively)

  // Example change within the return statement:
  return (
    <>
      {/* ... dev button ... */}
      ...
      >
        <Header isBlog /> {/* Assuming isBlog is okay, otherwise check Header component */}
        {mount && (
