// Entries come from search-index.js (generated by build.py). Fall back to an
// empty list so the page never errors if that file is missing.
const notesEntries = (typeof notesSearchEntries !== "undefined" && notesSearchEntries) || [];
